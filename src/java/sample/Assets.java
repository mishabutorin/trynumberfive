...
public class Assets {
    ...
    static ImageView sovietSnakeHead = new ImageView(Assets.class.getClassLoader().getResource("images/soviethead.png").toString());
    static ImageView sovietSnakeBody = new ImageView(Assets.class.getClassLoader().getResource("images/sovietbody.png").toString());
}
